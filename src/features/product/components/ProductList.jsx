...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "Victorinox", label: "Victorinox", checked: false },
        ...
        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
          ...
          <div>
            ...
            >
              <a
                href="#"
                className="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-indigo-600 ring-inset hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
              >
